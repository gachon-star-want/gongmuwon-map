...
def test_print_source_registry_reports_nationwide_verification_state(
    ...
    assert output["summary"]["verified_in_code"] == 148
    assert output["summary"]["pending"] == 96
    assert output["summary"]["legal_hold"] == 136
    assert output["summary"]["source_not_found"] == 165
    ...
    assert output["summary"]["priority_group_counts"]["p1"]["legal_hold"] == 136
