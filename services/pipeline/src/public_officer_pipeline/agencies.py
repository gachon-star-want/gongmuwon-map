...
NON_CAPITAL_LEGAL_HOLD_BLOCKERS = {
    ...
    "세종시의회": {
        ...
        "blocker": (
            ...
            "공공누리 유형 표시가 확인되지 않았습니다. 제1유형 또는 명확한 자유이용 "
            "표시 확인 전까지 수집하지 않습니다."
        ),
    },
    "강원특별자치도청": {
...
NON_CAPITAL_BASIC_LEGAL_HOLD_BLOCKERS = {
    ...
    ("충청남도", "보령시의회"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비 목록과 최근 2025년 분기별 업무추진비 집행내역 게시물은 "
            "확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 또는 명확한 자유이용 "
            "표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청남도", "아산시청"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비공개 목록과 시장·부시장·국소장·실과장·읍면동장 업무추진비 "
            "공개대상 안내, 최근 2025년 XLSX/HWPX/PDF 첨부 구조는 확인했습니다. 다만 "
    ...
    ("충청남도", "계룡시청"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비 공개 목록과 최근 2025년 부서별 업무추진비 게시물, XLSX/PDF "
            "다운로드 구조는 확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 또는 "
    ...
    ("충청남도", "계룡시의회"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비공개 목록과 최근 2025년 분기별 의장·부의장 업무추진비 PDF "
            "다운로드 구조는 확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 또는 "
            "명확한 자유이용 표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청남도", "당진시청"): {
        "sourceUrl": (
            "https://www.dangjin.go.kr/cop/bbs/BBSMSTR_000000000024/"
            "selectBoardList.do"
        ),
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 부서장 업무추진비 공개 목록과 최근 2025년 업무추진비 집행내역 게시물, "
            "XLSX 첨부 구조는 확인했습니다. 다만 화면 하단 저작권 문구가 ALL RIGHTS "
            "RESERVED로 표시되고 공공누리 제1유형 또는 명확한 자유이용 표시가 확인되지 "
            "않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청남도", "당진시의회"): {
    ...
    ("충청남도", "금산군의회"): {
        ...
        "extraListUrls": [
            "https://www.geumsancouncil.go.kr/content/council/chairmanMovements.html"
        ],
        "fileKinds": ["xlsx"],
        "pageParam": "page",
        "followDetail": True,
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 정보공개 > 의회운영 > 업무추진비 현황 목록과 의장동정 업무추진비 "
            "사용내역 목록, 최근 2025년 XLSX 첨부 구조는 확인했습니다. 다만 목록/상세 "
            "화면에서 공공누리 제1유형 또는 명확한 자유이용 표시가 확인되지 않아 "
            "제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청남도", "서천군청"): {
        "sourceUrl": (
            "https://seocheon.go.kr/cop/bbs/BBSMSTR_000000000102/"
            "selectBoardList.do"
        ),
        "extraListUrls": [
            (
                "https://seocheon.go.kr/cop/bbs/BBSMSTR_000000000673/"
                "selectBoardList.do"
            )
        ],
        "fileKinds": ["pdf"],
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 군수 업무추진비공개 및 본청 업무추진비공개 목록, 최근 2025년 PDF "
    ...
    ("충청남도", "홍성군의회"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비 내역 목록과 최근 2025년 분기별 홍성군의회 업무추진비 "
            "사용내역 XLSX 첨부 구조는 확인했습니다. 다만 목록/상세 화면에서 공공누리 "
            "제1유형 또는 명확한 자유이용 표시가 확인되지 않아 제1유형 확인 전까지 "
            "수집하지 않습니다."
        ),
    },
    ("충청남도", "예산군청"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비공개 목록과 열린군수실 업무추진비 목록, 최근 2025년 XLSX/PDF "
            "첨부 구조는 확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 또는 "
            "명확한 자유이용 표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청남도", "예산군의회"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 의정활동 업무추진비 목록과 최근 2025년 분기별 의회운영업무추진비 "
            "XLS 첨부 구조는 확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 "
            "또는 명확한 자유이용 표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청남도", "태안군청"): {
        "sourceUrl": (
            "https://www.taean.go.kr/cop/bbs/BBSMSTR_000000000321/"
            "selectBoardList.do"
        ),
        "fileKinds": ["pdf"],
        "pageParam": "pageIndex",
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 부서장 업무추진비 목록과 최근 2025년 분기별 PDF 첨부 구조는 "
            "확인했습니다. 다만 태안군 공식 화면의 공공누리 표시는 제4유형 "
            "(출처표시+상업적이용금지+변경금지)으로 확인되어 제1유형 원칙을 바꾸는 "
            "ADR·법적 결정 전까지 수집하지 않습니다."
        ),
    },
    ("충청남도", "태안군의회"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비 집행내역 목록과 최근 2025년 의회운영업무추진비 집행내역 "
            "게시물은 확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 또는 "
            "명확한 자유이용 표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("부산광역시", "금정구청"): {
    ...
    ("충청북도", "옥천군청"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비(군수·부군수) 목록과 부서별 업무추진비 목록, 최근 2025년 "
            "게시물·XLSX 첨부 구조는 확인했습니다. 다만 업무추진비 목록 화면이 공공누리 "
            "제4유형(출처표시+상업적이용금지+변경금지)으로 표시되어 제1유형 원칙을 "
            "바꾸는 ADR·법적 결정 전까지 수집하지 않습니다."
        ),
    },
    ("충청북도", "영동군청"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비 목록과 2025년 3·4분기 업무추진비 게시물, XLSX 첨부 구조는 "
            "확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 또는 명확한 "
            "자유이용 표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청북도", "증평군의회"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비 목록과 2025년 월별·분기별 업무추진비 게시물, XLSX 첨부 "
            "구조는 확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 또는 명확한 "
            "자유이용 표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청북도", "진천군의회"): {
        "sourceUrl": (
            "https://council.jincheon.go.kr/council/selectBbsNttList.do?"
            "bbsNo=67&key=114"
        ),
        "fileKinds": ["xlsx"],
        "pageParam": "pageIndex",
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무 추진비 공개 목록과 2025년 월별 업무추진비 사용내역 게시물, "
    ...
    ("충청북도", "괴산군청"): {
        "sourceUrl": (
            "https://goesan.go.kr/www/selectBbsNttList.do?"
            "bbsNo=202&integrDeptCode=&key=1731"
        ),
        "extraListUrls": [
            (
                "https://www.goesan.go.kr/www/selectBbsNttList.do?"
                "bbsNo=351&integrDeptCode=&key=1729"
            )
        ],
        "fileKinds": ["xlsx", "xls"],
        "pageParam": "pageIndex",
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 부서·읍·면장 업무추진비 및 부단체장 업무추진비 목록과 최근 2025년 "
            "게시물·XLSX 첨부 구조는 확인했습니다. 다만 목록/상세 화면에서 공공누리 "
            "제1유형 또는 명확한 자유이용 표시가 확인되지 않아 제1유형 확인 전까지 "
            "수집하지 않습니다."
        ),
    },
    ("충청북도", "괴산군의회"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비 목록과 최근 2025년 업무추진비 집행내역 게시물, XLS 첨부 "
            "구조는 확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 또는 명확한 "
            "자유이용 표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청북도", "음성군의회"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비 목록과 2025년 월별 업무추진비 사용현황 게시물·첨부 구조는 "
            "확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 또는 명확한 자유이용 "
            "표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청북도", "단양군청"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 업무추진비 목록과 최근 2025년 군수·부군수·부서 업무추진비 게시물, "
            "다운로드 파일 구조는 확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 "
            "또는 명확한 자유이용 표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("충청북도", "단양군의회"): {
        ...
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "단양군 공식 업무추진비 통합 목록에서 2025년 단양군의회 업무추진비 집행내역 "
            "게시물을 확인했습니다. 다만 목록/상세 화면에서 공공누리 제1유형 또는 명확한 "
            "자유이용 표시가 확인되지 않아 제1유형 확인 전까지 수집하지 않습니다."
        ),
    },
    ("울산광역시", "남구청"): {
...
CHUNGCHEONG_SOURCE_NOT_FOUND_EVIDENCE: dict[tuple[str, str], dict[str, object]] = {
    ("대전광역시", "서구의회"): {
        "searchedPaths": [
            "site:council.seogu.go.kr 업무추진비 서구의회",
            "site:www.seogucouncil.daejeon.kr 업무추진비",
            "대전광역시 서구의회 공식 누리집 의정활동·정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "충청도권 2차 source discovery에서 대전 서구의회 공식 도메인과 "
            "업무추진비·의장 업무추진비 검색어를 확인했지만, dry-run 가능한 공식 "
            "업무추진비 목록 URL과 공공누리 제1유형 또는 명확한 상업적 자유이용 "
            "근거를 확정하지 못했습니다."
        ),
    },
    ("충청북도", "충주시청"): {
        "searchedPaths": [
            "site:chungju.go.kr 충주시청 업무추진비",
            "충주시청 업무추진비 2025년 xlsx",
            "충주시 공식 누리집 정보공개·사전정보공표·업무추진비 메뉴",
        ],
        "blocker": (
            "공식 사이트와 검색 결과에서 충주시청 업무추진비 공개 목록을 확정하지 못했습니다. "
            "학교·언론 등 비공식 또는 비대상 결과만 확인되어 source_not_found로 보류합니다."
        ),
    },
    ("충청북도", "제천시의회"): {
        "searchedPaths": [
            "site:council.jecheon.go.kr 제천시의회 업무추진비",
            "제천시의회 업무추진비 2025",
            "제천시의회 공식 누리집 의회소식·정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "제천시의회 공식 업무추진비 목록 URL, 첨부 패턴, 공공누리 제1유형 또는 "
            "명확한 자유이용 근거를 확정하지 못했습니다."
        ),
    },
    ("충청북도", "보은군청"): {
        "searchedPaths": [
            "site:boeun.go.kr 보은군청 업무추진비 2025",
            "보은군청 군수 업무추진비 2025",
            "보은군 공식 누리집 정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "보은군 공식 업무추진비 목록 URL을 확정하지 못했습니다. 검색 결과는 과거 "
            "언론 보도와 직원 업무분장 중심이라 production 적재 후보로 사용할 수 없습니다."
        ),
    },
    ("충청북도", "보은군의회"): {
        "searchedPaths": [
            "site:council.boeun.go.kr 보은군의회 업무추진비",
            "보은군의회 업무추진비 공개",
            "보은군의회 공식 누리집 의회소식·정보공개 메뉴",
        ],
        "blocker": (
            "보은군의회 공식 업무추진비 게시판은 확정하지 못했고, 확인된 공식 화면은 "
            "의회사무과 업무분장과 ALL RIGHTS RESERVED 푸터 중심입니다."
        ),
    },
    ("충청북도", "옥천군의회"): {
        "searchedPaths": [
            "site:council.oc.go.kr 옥천군의회 업무추진비",
            "옥천군의회 업무추진비 2025",
            "옥천군의회 공식 누리집 의회소식·정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "옥천군의회 공식 업무추진비 목록 URL과 첨부 패턴, 공공누리 제1유형 근거를 "
            "확정하지 못했습니다."
        ),
    },
    ("충청북도", "영동군의회"): {
        "searchedPaths": [
            "site:council.yd21.go.kr 영동군의회 업무추진비",
            "영동군의회 업무추진비 2025",
            "영동군의회 공식 누리집 정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "영동군의회 공식 업무추진비 목록 URL, 최근 12개월 첨부 패턴, 공공누리 "
            "제1유형 근거를 확정하지 못했습니다."
        ),
    },
    ("충청북도", "증평군청"): {
        "searchedPaths": [
            "site:jp.go.kr 증평군청 업무추진비",
            "증평군청 업무추진비 2025 xlsx",
            "증평군 공식 누리집 정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "증평군 공식 누리집에 업무추진비 메뉴는 확인되지만, 최근 12개월 집행내역 "
            "목록 URL과 첨부 패턴을 확정하지 못했습니다."
        ),
    },
    ("충청북도", "진천군청"): {
        "searchedPaths": [
            "site:www.jincheon.go.kr 진천군청 업무추진비 2025",
            "진천군청 업무추진비 selectBbsNttList",
            "진천군 공식 누리집 정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "진천군청 공식 업무추진비 공개 목록 URL과 공공누리 제1유형 근거를 확정하지 "
            "못했습니다. 진천군의회 업무추진비 목록은 별도 legal_hold로 분류했습니다."
        ),
    },
    ("충청북도", "음성군청"): {
        "searchedPaths": [
            "site:eumseong.go.kr 음성군청 업무추진비 2025",
            "음성군 기관장 업무추진비",
            "음성군 공식 누리집 정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "음성군청 공식 업무추진비 목록 URL과 첨부 패턴을 확정하지 못했습니다. "
            "음성군의회 업무추진비 목록은 별도 legal_hold로 분류했습니다."
        ),
    },
    ("충청남도", "아산시의회"): {
        "searchedPaths": [
            "site:asansicouncil.go.kr 업무추진비 2025",
            "아산시의회 업무추진비 현황",
            "아산시의회 공식 누리집 정보공개·의정활동 업무추진비 메뉴",
        ],
        "blocker": (
            "아산시의회 공식 업무추진비 목록 URL은 확정하지 못했습니다. 검색 결과는 "
            "예산심사 기사와 일반 의정활동 중심이라 production 적재 후보로 사용할 수 없습니다."
        ),
    },
    ("충청남도", "서산시의회"): {
        "searchedPaths": [
            "site:council.seosan.go.kr 서산시의회 업무추진비",
            "site:www.scc.go.kr 서산시의회 업무추진비",
            "서산시의회 공식 누리집 정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "서산시의회 공식 업무추진비 목록 URL, 최근 12개월 첨부 패턴, 공공누리 "
            "제1유형 근거를 확정하지 못했습니다."
        ),
    },
    ("충청남도", "금산군청"): {
        "searchedPaths": [
            "site:geumsan.go.kr 금산군청 업무추진비 2025",
            "금산군청 업무추진비 공개",
            "금산군 공식 누리집 정보공개·군수 업무추진비 메뉴",
        ],
        "blocker": (
            "금산군청 공식 업무추진비 목록 URL과 첨부 패턴을 확정하지 못했습니다. "
            "금산군의회 업무추진비 목록은 별도 legal_hold로 분류했습니다."
        ),
    },
    ("충청남도", "서천군의회"): {
        "searchedPaths": [
            "site:scouncil.go.kr 서천군의회 업무추진비 2025",
            "서천군의회 업무추진비 집행내역",
            "서천군의회 공식 누리집 의회소식·정보공개 메뉴",
        ],
        "blocker": (
            "서천군의회 공식 업무추진비 목록 URL과 첨부 패턴을 확정하지 못했습니다. "
            "검색 결과는 언론 보도와 타 의회 고시공고 결과 중심입니다."
        ),
    },
    ("충청남도", "청양군청"): {
        "searchedPaths": [
            "site:cheongyang.go.kr 청양군청 업무추진비 2025",
            "청양군청 업무추진비 집행내역",
            "청양군 공식 누리집 정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "청양군청 공식 업무추진비 목록 URL과 첨부 패턴을 확정하지 못했습니다. "
            "검색 결과는 규칙·예산자료·언론 기사 중심입니다."
        ),
    },
    ("충청남도", "청양군의회"): {
        "searchedPaths": [
            "site:council.cheongyang.go.kr 청양군의회 업무추진비",
            "청양군의회 업무추진비 집행내역",
            "청양군의회 공식 누리집 의정활동 정보공개 메뉴",
        ],
        "blocker": (
            "청양군의회 공식 화면에서 업무추진비 집행내역 메뉴명은 확인했지만, dry-run "
            "가능한 목록 URL·최근 12개월 첨부 패턴·공공누리 제1유형 근거를 확정하지 "
            "못했습니다."
        ),
    },
    ("충청남도", "홍성군청"): {
        "searchedPaths": [
            "site:hongseong.go.kr 홍성군청 업무추진비 2025",
            "홍성군수 업무추진비 집행내역",
            "홍성군 공식 누리집 정보공개·업무추진비 메뉴",
        ],
        "blocker": (
            "홍성군청 공식 업무추진비 목록 URL과 첨부 패턴을 확정하지 못했습니다. "
            "검색 결과는 정보공개청구 기반 언론 분석 기사 중심입니다."
        ),
    },
}
...
def _apply_chungcheong_source_not_found(
    ...
    if source_pattern.get("status") != "adapter_required" or source_pattern.get("holdStatus"):
        return
    evidence = CHUNGCHEONG_SOURCE_NOT_FOUND_EVIDENCE.get((parent_region, short_name))
    if not evidence:
        return
    source_pattern.update({"holdStatus": "source_not_found", **evidence})
