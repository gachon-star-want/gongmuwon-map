...
NON_CAPITAL_BASIC_OFFICE_ATTACHMENT_BOARDS = {
    ...
    ("경상북도", "영주시청"): {
        "homepage": "https://www.yeongju.go.kr",
        "listUrl": "https://www.yeongju.go.kr/open_content/main/page.do?mnu_uid=11132",
        "fileKinds": ["pdf"],
        "followDetail": True,
        "pageParam": "pageNo",
        "verifiedAt": "2026-06-02",
        ...
        "evidenceNote": (
            "공식 시장 업무추진비 목록과 최근 분기별 PDF 첨부 구조를 확인했습니다. 공식 "
            "기관 사이트에 공개된 업무추진비 집행내역에서 원본 파일은 재배포하지 않고 "
            "날짜·기관·부서/직급 마스킹·장소·금액·목적 등 factual row만 추출·정규화하는 "
            "적재 정책에 맞습니다. 2026-06-02 dry-run에서 posts_seen=1, raw_parsed_rows=109, "
            "normalized_visits=109를 확인했고 production DB 기준 sources=1, places=78, "
            "visits=109를 확인했습니다. 목록/상세 화면에서 명시적 재사용 제한 문구는 "
            "확인하지 못했습니다."
        ),
    },
    ("대구광역시", "군위군청"): {
...
NON_CAPITAL_BASIC_COUNCIL_ATTACHMENT_BOARDS = {
    ("대구광역시", "달서구의회"): {
        "homepage": "https://www.dalseocouncil.daegu.kr",
        "listUrl": "https://www.dalseocouncil.daegu.kr/content/dataroom/operatingExpense.html",
        "fileKinds": ["xlsx"],
        "followDetail": True,
        "pageParam": "page",
        "verifiedAt": "2026-06-02",
        "verifiedBy": "공식 사이트 원격 확인 및 production dry-run 검증",
        "evidenceNote": (
            "공식 업무추진비 목록과 2026년 업무추진비·의정공통경비 XLSX 첨부 구조를 "
            "확인했습니다. 공식 기관 사이트에 공개된 업무추진비 집행내역에서 원본 파일은 "
            "재배포하지 않고 날짜·기관·부서/직급 마스킹·장소·금액·목적 등 factual row만 "
            "추출·정규화하는 적재 정책에 맞습니다. 2026-06-02 dry-run에서 posts_seen=5, "
            "raw_parsed_rows=24, normalized_visits=24를 확인했고 production DB 기준 "
            "sources=3, places=21, visits=24를 확인했습니다. 목록/상세 화면에서 명시적 "
...
NON_CAPITAL_BASIC_LEGAL_HOLD_BLOCKERS = {
    ...
    ("부산광역시", "사상구청"): {
        ...
        "pageParam": "startPage",
        "followDetail": True,
        "copyrightUrl": "https://www.sasang.go.kr/index.sasang?menuCd=DOM_000000116004000000",
        "publicWorksPolicyUrl": "https://www.sasang.go.kr/index.sasang?menuCd=DOM_000000116004000000",
        "verifiedAt": "2026-06-02",
        "verifiedBy": "공식 사이트 원격 확인",
        "blocker": (
            "공식 부서 업무추진비와 구청장 업무추진비 공개 목록, 상세·HWPX 첨부 구조는 "
            "확인했습니다. 다만 공식 저작권정책에서 공공누리 미부착 자료는 자료관리부서 "
            "담당자와 사전 협의 후 이용하라고 명시되어 있어 최신 facts-only 기준에서도 "
            "production 적재하지 않습니다. 확인 URL: "
            "https://www.sasang.go.kr/index.sasang?menuCd=DOM_000000116004000000"
        ),
    },
    ("부산광역시", "사상구의회"): {
        "sourceUrl": (
        ...
        "publicWorksPolicyUrl": "https://www.sasang.go.kr/index.sasang?menuCd=DOM_000000116004000000",
        "verifiedAt": "2026-06-02",
        "verifiedBy": "공식 사이트 원격 확인 및 dry-run 검증",
        "blocker": (
            "공식 업무추진비 현황 목록과 최근 의회운영업무추진비·의정운영공통경비·의회사무국 "
            "업무추진비 PDF 첨부 구조는 확인했고, 2026-06-02 dry-run에서 posts_seen=2 "
            "이후 scanned PDF vision extraction이 필요했지만 현재 실행 환경에 LLM vision "
            "API key가 없어 raw_parsed_rows=0으로 실패했습니다. 또한 공식 저작권정책에서 "
            "공공누리 미부착 자료는 자료관리부서 담당자와 사전 협의 후 이용하라고 명시되어 "
            "있어 최신 facts-only 기준에서도 production 적재하지 않습니다. 확인 URL: "
            "https://www.sasang.go.kr/index.sasang?menuCd=DOM_000000116004000000"
        ),
    },
    ("부산광역시", "중구청"): {
    ...
    ("충청북도", "영동군청"): {
        ...
        "referer": "https://www.yd21.go.kr/kr/html/sub03/030504.html",
        "verifiedAt": "2026-06-02",
        "verifiedBy": "공식 사이트 원격 재확인",
        "blocker": (
    ...
    ("울산광역시", "동구의회"): {
        ...
        "blocker": (
            ...
            "첨부 구조는 확인했습니다. 공식 기관 사이트에 공개된 업무추진비 집행내역에서 "
            "원본 파일은 재배포하지 않고 날짜·기관·부서/직급 마스킹·장소·금액·목적 등 "
            "factual row만 추출·정규화하는 적재 정책에 맞습니다. 2026-06-02 dry-run에서 "
            "posts_seen=2, raw_parsed_rows=21, normalized_visits=21을 확인했고 "
            "production DB 기준 sources=2, places=17, visits=21을 확인했습니다. 메타·푸터의 "
            "ALL RIGHTS RESERVED 외에 명시적 재사용 제한 문구는 확인하지 못했습니다."
        ),
    },
    ("경상북도", "포항시청"): {
    ...
    ("경상남도", "거제시청"): {
        ...
        "copyrightUrl": "https://www.geoje.go.kr/index.geoje?menuCd=DOM_000008908004001000",
        "publicWorksPolicyUrl": "https://www.geoje.go.kr/index.geoje?menuCd=DOM_000008908004001000",
        "fileKinds": ["xlsx"],
        "pageParam": "startPage",
        "followDetail": True,
        "verifiedAt": "2026-06-02",
        "verifiedBy": "공식 사이트 원격 확인 및 dry-run 검증",
        "blocker": (
            "공식 시장 업무추진비 공개 목록과 최근 XLSX 첨부 구조는 확인했고, 2026-06-02 "
            "dry-run에서 posts_seen=3, raw_parsed_rows=204, normalized_visits=203까지 "
            "확인했습니다. 다만 공식 저작권정책에서 공공누리가 부착되지 않은 자료는 "
            "공공저작물 관리책임관 및 실무담당자와 사전에 협의하여 이용하라고 명시되어 "
            "있습니다. 이는 사전 협의 필요 문구에 해당하므로 최신 facts-only 기준에서도 "
            "production 적재하지 않습니다. 확인 URL: "
            "https://www.geoje.go.kr/index.geoje?menuCd=DOM_000008908004001000"
        ),
    },
    ("경상남도", "양산시청"): {
...
GYEONGSANG_DRY_RUN_HOLDS: dict[tuple[str, str], tuple[str, str]] = {
    ...
    ("울산광역시", "북구의회"): (
        "adapter_hold",
        "경상도권 6차 dry-run에서 공식 업무추진비공개 URL은 확인했지만 posts_seen=0이었습니다. "
        "울산 북구의회 openspace.do 목록/상세 parser 보강이 필요합니다.",
    ),
    ("울산광역시", "울주군청"): (
        "adapter_hold",
    ...
    ("경상남도", "김해시청"): (
        "pdf_vision_hold",
        "경상도권 7차 dry-run에서 공식 시장·부시장/실국장/과장급 업무추진비 목록은 확인했고 "
        "posts_seen=5, posts_fetched=1 이후 scanned PDF vision extraction이 필요했지만 현재 "
...
CHUNGCHEONG_DISCOVERY_OVERRIDES: dict[tuple[str, str], dict[str, object]] = {
    ("대전광역시", "서구의회"): {
        ...
        "holdStatus": "no_recent_data",
        "verifiedAt": "2026-06-02",
        "verifiedBy": "공식 사이트 원격 재확인 및 2020-01-01 확장 dry-run",
        "searchedPaths": [
        ...
        "blocker": (
            ...
            "2026-06-02 재확인 시 목록 form의 schTotalCnt=0으로 표시되었습니다. "
            "since/row-since 2020-01-01 확장 dry-run도 posts_seen=0, normalized_visits=0으로 "
            "성공 종료되어 현재 place-level 업무추진비 적재 대상이 없습니다."
        ),
    },
    ("충청북도", "충주시청"): {
        "adapter": "attachment_board",
    ...
    ("충청남도", "서천군의회"): {
        "adapter": "attachment_board",
        "listUrl": "https://www.scouncil.go.kr/cop/bbs/BBSMSTR_000000000627/selectBoardList.do",
        "sourceUrl": "https://www.scouncil.go.kr/cop/bbs/BBSMSTR_000000000627/selectBoardList.do",
        "fileKinds": ["xlsx", "xls"],
        "pageParam": "pageIndex",
        "followDetail": True,
        "userAgent": (
        ...
        "referer": "https://www.scouncil.go.kr/cop/bbs/BBSMSTR_000000000627/selectBoardList.do",
        "verifiedAt": "2026-06-02",
        "verifiedBy": "공식 사이트 원격 재확인 및 facts-only 적재 정책 재검토",
        "searchedPaths": [
            "site:scouncil.go.kr 업무추진비",
            "site:scouncil.go.kr 의장 업무추진비",
            "https://www.scouncil.go.kr",
            "https://www.scouncil.go.kr/cop/bbs/BBSMSTR_000000000627/selectBoardList.do",
            "서천군의회 정보공개 게시판",
        ],
        "evidenceNote": (
            "서천군의회 공식 홈페이지의 정보공개 게시판에서 2026년·2025년 의회사무과 "
            "의회운영업무추진비, 공통경비 및 기관·부서·시책추진 업무추진비 사용내역 "
            "게시물과 XLS/XLSX 첨부를 확인했습니다. 원문 재배포 없는 facts-only 적재 "
            "정책 기준에서 명시적 상업적 이용 금지·변경 금지·사전협의 요구는 확인되지 "
            "않아 dry-run 재검증 대상입니다."
        ),
    },
    ("충청남도", "청양군의회"): {
        "adapter": "council_attachment_board",
    ...
    ("충청남도", "홍성군청"): {
        ...
        "referer": "https://www.hongseong.go.kr/bbs/BBSMSTR_000000000811/list.do",
        "verifiedAt": "2026-06-02",
        "verifiedBy": "공식 사이트 원격 재확인 및 ZIP 내부 XLS 추출 adapter 보강",
        "searchedPaths": [
            "site:hongseong.go.kr 업무추진비",
            "site:hongseong.go.kr 군수 업무추진비",
        ...
        "evidenceNote": (
            "홍성군청 공식 업무추진비 목록과 최근 게시물의 fn_zipDownload/zipDownload.do "
            "묶음 첨부를 확인했습니다. ZIP 내부 2026년 분기 XLS 파일을 안전하게 선택·"
            "추출하는 adapter를 보강했으며, 원문 재배포 없는 facts-only 적재 정책 "
            "기준에서 명시적 상업적 이용 금지·변경 금지·사전협의 요구는 확인되지 "
            "않아 dry-run 재검증 대상입니다."
        ),
    },
    ("충청남도", "청양군청"): {
...
CHUNGCHEONG_DRY_RUN_HOLDS: dict[tuple[str, str], tuple[str, str]] = {
    ("충청남도", "계룡시의회"): (
        "pdf_vision_hold",
        "충청도권 기술 blocker 재시도에서 공식 계룡시의회 업무추진비 PDF는 "
        "posts_seen=1, posts_fetched=1까지 진행됐지만 raw_parsed_rows=0이고 scanned "
        "PDF vision extraction이 필요했습니다. 현재 실행 환경에 LLM vision API key가 "
        "없어 'At least one LLM API key is required for scanned PDF vision extraction' "
        "오류가 5회 재현되어 production 적재하지 않습니다.",
    ),
    ("충청남도", "청양군의회"): (
        "pdf_vision_hold",
        "충청도권 기술 blocker 재시도에서 공식 청양군의회 업무추진비 PDF는 "
        "posts_seen=1, posts_fetched=1까지 진행됐지만 raw_parsed_rows=0이고 scanned "
        "PDF vision extraction이 필요했습니다. 현재 실행 환경에 LLM vision API key가 "
        "없어 'At least one LLM API key is required for scanned PDF vision extraction' "
        "오류가 5회 재현되어 production 적재하지 않습니다.",
    ...
    ("충청남도", "부여군청"): (
        "adapter_hold",
        "충청도권 기술 blocker 재시도에서 공식 부여군청 업무추진비 목록과 HWP 첨부는 "
        "posts_seen=1, posts_fetched=1까지 진행됐지만 services/pipeline/src/"
        "public_officer_pipeline/extractor/hwp.py의 LibreOffice 변환 경로가 "
        "'LibreOffice HWP conversion produced no HTML output' 오류를 5회 재현했습니다. "
        "hwp5txt 등 안정적인 HWP 5.x extractor 또는 변환 adapter 보강 전에는 "
        "production 품질로 적재하지 않습니다.",
    ),
}
